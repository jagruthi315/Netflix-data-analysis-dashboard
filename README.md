...
•	File format- .pbit for develpment and .png for dashboard previews.
**
Dataset Description-**
...
Screenshot- (https://github.com/jagruthi315/Netflix-data-analysis-dashboard/blob/main/Netflix%20dashboard.PNG)
